...
if __name__ == "__main__":
    ...
    zero_shot.run_zero_shot_classification_medclipmodel(medical_type, batch_size, generators, lengths)
    ...
    generators, lengths = load_data.create_loader(medical_type,batch_size,model_type)
    visualize.save_random_images_from_generators(generators,[medical_type,model_type],2)
    zero_shot.run_zero_shot_classification_clipmodel(medical_type, batch_size, generators, lengths)
